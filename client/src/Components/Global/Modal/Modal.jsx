...
/* let renderLoader = () => <ClipLoader size={15} loading={true} />; */
const Modal = ({
  isOpen,
  setOpenModal,
  title = "Alerta",
                ...
                if (method === "post") {
                  axios
                    ...
                    .then((res) => {
                      ...
                      notify("Se ha agregado correctamente! 👌");
                    })
                    .catch((error) => {
                      actions.setSubmitting(false);
...
const Overlay = styled.div`
  ...
  left: 0;
  background: ${(props) =>
    props.withOverlay ? "rgba(0,0,0,.5)" : "rgba(0,0,0,0)"};
  padding: 40px;
  display: flex;
  align-items: center;
